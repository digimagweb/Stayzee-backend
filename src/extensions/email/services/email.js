    ...
    try {
      ...
      await strapi
        ...
        .send({
          ...
          html: emailTemplate,
          text: this.generateTextVersion(bookingData), // Add text version
        });

      strapi.log.info(
        `✅ Booking confirmation sent to ${bookingData.customer_email}`
      );
      return { success: true };
    } catch (error) {
      strapi.log.error("❌ Failed to send booking email:", error);
            ...
            <div class="card">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">${bookingData.booking_reference}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Property</div>
                        <div class="detail-value">${bookingData.property_name}</div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">${bookingData.guests}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Total Nights</div>
                        <div class="detail-value">${bookingData.total_nights}</div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">${bookingData.property_type}</div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">${bookingData.customer_phone}</div>
                    </div>
                </div>
            </div>
